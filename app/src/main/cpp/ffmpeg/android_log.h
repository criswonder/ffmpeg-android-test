...
#define LOGI(format, ...)  __android_log_print(ANDROID_LOG_INFO, MY_TAG, format, ##__VA_ARGS__)
#define LOGW(format, ...)  __android_log_print(ANDROID_LOG_WARN, MY_TAG, format, ##__VA_ARGS__)
